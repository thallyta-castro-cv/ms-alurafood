...
| Load Balancer| Distribuição de Carga         | O Load Balancer distribui o tráfego entre várias instâncias dos microserviços, garantindo que a carga seja distribuída de maneira equitativa. Isso melhora a escalabilidade e a confiabilidade do sistema. Neste projeto o gateway registra todas as instancias de auto scaling e distribui a carga entre elas. | Projeto `gateway`                 |
